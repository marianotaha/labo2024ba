...
AgregarVariables_IntraMes <- function(dataset) {
  ...
  kmedias <- KMeans_rcpp(datasetsinNA[,1:154], clusters = 10, num_init = 1, initializer = "kmeans++")
...
cat( "z1301_FE_intrames_manual_009_cluster10.r  START\n")
action_inicializar() 
...
cat( "z1301_FE_intrames_manual_009_cluster10.r  END\n")
