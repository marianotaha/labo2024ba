...
FEintra_manual_base <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1301_FE_intrames_manual_modelofinal1.r"
...
HT_tuning_base <- function( pinputexps, bypass=FALSE)
{
  ...
  param_local$lgb_param <- list(
    ...
    num_leaves = c( 8L, 8192L,  "integer" ),
    min_data_in_leaf = c( 100L, 12000L, "integer" ),
  ...
  param_local$bo_iteraciones <- 90 # iteraciones de la Optimizacion Bayesiana
