...
for (vmax_depth in c(4, 6, 8, 10, 12, 14)) {
  for (vmin_split in c(1000, 800, 600, 400, 200, 100, 50, 20, 10)) {
    for (vmin_bucket in c(ceiling(vmin_split*0.1),ceiling(vmin_split*0.2),
                          ceiling(vmin_split*0.3),ceiling(vmin_split*0.4),
                          ceiling(vmin_split*0.48))){
      for (vcp in c(-1,-0.75,-0.5,-0.25)){
