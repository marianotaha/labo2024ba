...
PARAM$finalmodel$num_iterations <- 217
PARAM$finalmodel$learning_rate <- 0.0251028897133987
PARAM$finalmodel$feature_fraction <- 0.555787337095334
PARAM$finalmodel$min_data_in_leaf <- 20
PARAM$finalmodel$num_leaves <- 190
PARAM$finalmodel$min_gain_to_split <- 0.109047516934169
PARAM$finalmodel$lambda_l1 <- 1.32483001614769
PARAM$finalmodel$lambda_l2 <- 7.56678232122104
PARAM$finalmodel$bagging_fraction <- 0.717191816286861
