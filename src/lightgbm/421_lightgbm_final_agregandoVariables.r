...
dataset$agregado1 <- dataset$Visa_mconsumototal / dataset$Visa_mlimitecompra
dataset$agregado2 <- dataset$mcaja_ahorro + dataset$mcuenta_corriente + dataset$mplazo_fijo_pesos +
  dataset$mplazo_fijo_dolares+ dataset$minversion1_pesos + dataset$minversion1_dolares + dataset$minversion2
dataset$agregado3 <- dataset$mpayroll / dataset$cliente_edad
